...
function crearTarjetaHTML(p) {
    ...
    // Bloque visual de ficha técnica si ya fue asignada
    ...
    return `
        <div class="glass-card admin-card">
            ...
            <div class="admin-card-actions">
                <button class="btn-action" onclick="abrirModalTecnico('${p.codigo}', '${p.impresora || 'Bambu'}', '${p.gramos || ''}', '${p.tipoMaterial || 'PLA'}')" title="Asignar Impresora y Material"><i class="fa-solid fa-sliders" style="color: var(--primary);"></i> Ficha</button>
...
// ==========================================
// 5. ACCIONES Y MODALES EN FIREBASE
// ==========================================
...
// --- FICHA TÉCNICA DE IMPRESORA Y MATERIAL ---
...
// --- ELIMINAR DEFICITIVAMENTE ---
async function eliminarPedido(codigo) {
    const confirmar = confirm(`¿Estás seguro de que deseas eliminar permanentemente el pedido ${codigo}? Esta acción no se puede deshacer.`);
